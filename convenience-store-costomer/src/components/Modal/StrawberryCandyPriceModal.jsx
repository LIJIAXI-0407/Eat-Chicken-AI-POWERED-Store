...
const StrawberryCandyPriceModal = () => {
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Indulge in the irresistible taste of Strawberry Candy – bursting with juicy, tangy-sweet strawberry flavor! Made with natural fruit extracts.
            </p>
          </div>
        </div>
...
export default StrawberryCandyPriceModal; 