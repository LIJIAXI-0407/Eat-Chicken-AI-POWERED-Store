...
const DeliciousPastaPriceModal = () => {
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Savor the rich flavors of our Delicious Pasta, made with premium ingredients for a satisfying meal.
            </p>
          </div>
        </div>
...
export default DeliciousPastaPriceModal; 