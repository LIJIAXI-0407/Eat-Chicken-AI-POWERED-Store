        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Delicious Japanese street food, featuring octopus-filled dumplings with a crispy exterior and soft interior.
            </p>
          </div>
        </div>
...
export default TakoYakiPriceModal; 